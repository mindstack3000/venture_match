...
const Features= () => {
    return(
        <>
        <div className="bg-black flex space x-4">
            <div className=" lg:p-4 md:w-full flex justify-center mt-40">
                <div className="bg-white max-w-sm rounded-2xl overflow-hidden shadow-lg">
                    <Image  src={InvestorDash} alt=""  className="w-full"/>
            ...
            <div className="lg:p-4 md:w-full flex justify-center mt-40">
                <div className="bg-white max-w-sm rounded-2xl overflow-hidden shadow-lg">
                <Image  src={Company_Profile} alt=""  className="w-full"/>
                    <div className="px-6 py-4 lg:h-44">
                        <div className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                            Company Profile
                        </div>
                        ...
                        <p className="text-gray-700 text-base">
                        Allow companies to create detailed profiles showcasing their business, 
                        financials, growth potential, and investment requirements.
                        </p>
                    </div>
                    <div className="px-6 pt-4 pb-2">
                    </div>
            ...
            <div className="lg:p-4 md:w-full flex justify-center mt-40">
                <div className="bg-white max-w-sm rounded-2xl overflow-hidden shadow-lg">
                <Image  src={Data_Analytics} alt=""  className="w-full"/>
                    <div className="px-6 py-4 lg:h-44">
                        <div className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                            Data Analytics
                        </div>
                        ...
                        <p className="text-gray-700 text-base">
                        Provide data analytics and insights to help investors make informed 
                        decisions and companies understand investor interests.
                        </p>
                    </div>
                    <div className="px-6 pt-4 pb-2">
                    </div>

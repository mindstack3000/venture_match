...
function Footer() {
	return (
		<>
			<div className="bg-[#0f172a] h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-4">
                <div className="left">
                    <div>
                    <Image src={Logo} alt="" className="object-scale-down max-h-full drop-shadow-md rounded-md m-auto" />
                        <div className="p-4">
                            <ul>

    ...
    <>
      <div className="h-screen">
        ...
        <div className="flex justify-center items-center w-full h-full">
          <div className="border-2 flex md:flex-row flex-col border-black w-[20%] py-2 h-full">
            {/* SideNav */}
            <div className="md:w-full w-full h-fit md:rounded-md md:h-full flex md:p-0 p-3 justify-between md:justify-evenly md:flex-col md:ml-2 bg-primary-100 ">
          ...
          <div className=" w-full flex flex-col items-center justify-center gap-10 overflow-scroll">
            <h1 className="uppercase text-3xl font-semibold mt-20">
              companies
            </h1>
